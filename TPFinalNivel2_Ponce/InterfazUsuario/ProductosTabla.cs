...
namespace InterfazUsuario
{
    public partial class ProductosTabla : Form
    {
        ...
        private void dgvTabla_CellMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            // Para Colocarlo en el mismo lugar que el recuadro de ProductoTabla.
        ...
        // Ir Archivo Programa para editarl run de pantalla principal y cambiar el nombre del formulario
        // para que empiece con el, que deseemos.
